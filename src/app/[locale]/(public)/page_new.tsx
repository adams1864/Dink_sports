...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800 overflow-x-hidden relative">
      ...
      <section className="flex flex-col md:flex-row h-auto md:h-[calc(100vh-80px)] items-start md:items-center relative pt-24 md:pt-0">
          ...
          <div className="w-full md:w-[50%] h-[550px] md:h-full relative z-10">
             ...
             >
               ...
               <div className="relative w-full h-full flex p-4 sm:p-10 gap-4">
                   ...
                   <div className="w-[60%] p-3 bg-black/70 rounded-lg shadow-2xl border border-[#D92323]/30">
          ...
          <div className="w-full md:w-[50%] flex flex-col justify-center px-8 md:px-16 lg:px-24 relative pt-12 pb-20 md:pt-0">
              ...
              <div className="relative z-30 text-center md:text-right max-w-lg mx-auto md:ml-auto">
                  ...
                  <Link href="/products" className="inline-block bg-[#D92323] text-white px-10 py-3 rounded-full font-bold shadow-xl md:shadow-2xl transition-all duration-300 transform hover:bg-red-700 hover:scale-[1.03] active:scale-[0.98] focus:outline-none focus:ring-4 focus:ring-red-300">
                      BUY NOW
                  </Link>
              </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-96 rounded-2xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#D92323]/20 to-orange-500/20" />
          ...
          <div>
            ...
            <div className="h-1 w-32 bg-[#D92323] mb-8" />
